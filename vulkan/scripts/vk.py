...
VULKAN_VERSIONS_AND_STRUCTS_MAPPING = {   'VK_VERSION_1_0': [],
    'VK_VERSION_1_1': [   {   'VkPhysicalDevice16BitStorageFeatures': 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES'},
    ...
    'VK_VERSION_1_3': [   {   'VkPhysicalDeviceDynamicRenderingFeatures': 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES'},
    ...
    'VK_VERSION_1_4': [   {   'VkPhysicalDeviceDynamicRenderingLocalReadFeatures': 'VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES'},
